...
export default class implements Theme {
  ...
  draw(
    ...
    STARS_FILL_STYLE.addColorStop(0, "hsl(0, 100%, 65%)");
    STARS_FILL_STYLE.addColorStop(30 / 360, "hsl(30, 100%, 65%)");
    STARS_FILL_STYLE.addColorStop(60 / 360, "hsl(60, 100%, 65%)");
    STARS_FILL_STYLE.addColorStop(90 / 360, "hsl(90, 100%, 65%)");
    STARS_FILL_STYLE.addColorStop(120 / 360, "hsl(120, 100%, 65%)");
